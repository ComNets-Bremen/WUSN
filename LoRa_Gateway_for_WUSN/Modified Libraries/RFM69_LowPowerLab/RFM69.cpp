...
bool RFM69::initialize(uint8_t freqBand, uint16_t nodeID, uint8_t networkID, uint8_t slaveSelectPin, uint8_t interruptPin, bool isRFM69HW)
{
  _slaveSelectPin = slaveSelectPin;
  _interruptPin = interruptPin;
  _isRFM69HW = isRFM69HW;
  ...
  _settings = SPISettings(2000000, MSBFIRST, SPI_MODE0);
  Serial.println("Settings configuered");
#endif
