# ATMEGA-based MoleNet

The first versions of MoleNet were quite similar to Arduino Uno boards.
Therefore, programming was based on that ecosystem. Those steps are required to
get MoleNet v1, v2 and v3 up and running.
